    ...
    if (isHost && sessionId && !isSaved) {
      const persistResults = async () => {
        try {
          ...
          if (res.success) {
            setIsSaved(true);
            toast.success('Battle metrics saved to Dashboard! ≡ƒÆ╛');
          }
        } catch (err) {
          ...
          <div className="flex items-end justify-center gap-4 sm:gap-8 w-full max-w-lg h-60 mt-6 border-b border-white/5 pb-2">
            ...
            {second ? (
              <div className="flex flex-col items-center flex-1">
                ...
                >
                  <span className="font-outfit text-xl font-bold text-gray-400">≡ƒÑê</span>
                </motion.div>
              </div>
            ...
            {winner ? (
              <div className="flex flex-col items-center flex-1">
                ...
                >
                  ...
                  <span className="font-outfit text-2xl font-black text-white">≡ƒææ</span>
                </motion.div>
              </div>
            ) : <div className="flex-1" />}
            ...
            {third ? (
              <div className="flex flex-col items-center flex-1">
                ...
                >
                  <span className="font-outfit text-lg font-bold text-amber-700">≡ƒÑë</span>
                </motion.div>
              </div>
            ) : <div className="flex-1" />}
                ...
                <button
                  onClick={async () => {
                    ...
                    try {
                      ...
                      if (res.success) {
                        setIsSaved(true);
                        toast.success('Results successfully saved! ≡ƒÆ╛');
                      }
                    } catch (err) {
